  ...
  return (
    <div className="space-y-6 pb-20">
      <div>
        ...
        <p className="text-gray-500 text-sm">Let's get you some water.</p>
      </div>
      ...
      {activeOrder && (
        <div className="bg-white border border-cyan-200 rounded-xl shadow-sm p-5">
          ...
          <Link href={`/vendor-orders/${activeOrder.id}`} className="block text-center mt-4 text-cyan-600 font-semibold text-sm hover:underline">
            View Details
          </Link>
        </div>
      )}
